...
//     const referralFromURL = searchParams?.get("id"); // get referral from ?id=...
...
//         phone: "",
//         password: "",
//         referral: "", // will populate via useEffect
//     });
...
//                         readOnly={!!referralFromURL} // lock if URL provided
//                     />
...
const RegistrationForm = () => {
    const searchParams = useSearchParams();
    const referralFromURL = searchParams?.get("id");
    const [loading, setLoading] = useState(false);
    const [error, setError] = useState("");
